...
export async function POST(request: Request) {
  try {
    ...
    // 3. Dispatch placement payment confirmation email asynchronously (do not block client on send failure)
    ...
    sendEmail({
      to: parentEmail,
      subject: 'Placement Confirmed - The Shadow Bridge',
      ...
      bodyHtml: `
        ...
        <p style="margin: 24px 0 0 0; font-size: 14px;">If you have any questions, please reach out to our helpdesk at <strong>+91 98123 45678</strong> or email <strong>support@shadowbridge.in</strong>.</p>
      `
    }).catch(err => {
